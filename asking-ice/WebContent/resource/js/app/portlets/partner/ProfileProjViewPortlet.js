ProfileProjViewPortlet = Class.extend({
	init: function()	{
		this.name = "ProfileProjViewPortlet";
	},
	...
	fetch: function()	{
		...
		this.onAjax('ajax', 'get-profile-info', {}, 'GET', {
			'onSuccess': function(ret)	{
				var tmplType = "ProjectTmpl";
				var tblName = "";
				var id = ret['primary_bind'];
				obj.dynamicRender(ret, tblName, id, tmplType, 'project', null, 1);
			},
		});
	},
	...
	dynamicRender: function(ret, tblName, id, tmplType, profileExtensionName, fatherID, level){
		...
		// console.log("profileExtension", profileExtensionName);
		...
		// console.log(obj.renderView(tmplType, {partner: ret}));
		for (var j in ret){
