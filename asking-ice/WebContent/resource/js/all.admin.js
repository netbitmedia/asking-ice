...
//									id: b.id || "Long"
						...
						_renderItem : function(a, b) {
							...
							if (objParam.type == 'expertise')	{
								...
								var avatar = b.avatar;
								str = "<a class='person'><img onerror='this.src=\"resource/images/unknown.png\"' src='avatar/"+avatar+"'></img><span style='float: right; color: #202020'>"+b.ans+" câu trả lời</span>";
								var catchwords = b.catchwords;
...
(function($) {
  ...
  $.extend($.facebox, {
    settings: {
      opacity      : 0,
      overlay      : true,
      loadingImage : ''+'/static/css/loading.gif',
      closeImage   : ''+'/static/css/closelabel.gif',
          ...
          <tbody> \
            ...
            <tr> \
              ...
              <td class="body"> \
                ...
                <div class="footer"> \
                  <a href="#" class="close"> \
                    <img src="/static/includes/facebox/closelabel.gif" title="close" class="close_image" /> \
                  </a> \
                </div> \
              </td> \
              <td class="b"/> \
...
$(document).ready(function()	{
	$.get(ApplicationRoot+'/resource/microtemplating/all.admin.txt', {}, function(ret)	{
